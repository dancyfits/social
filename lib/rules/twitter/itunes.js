    ...
    SchemaUtils.getMetaOfPage(content, function(err, meta) {
      ...
      if(meta[ 'twitter-card' ] !== null && 
        ...
        if(type === 'app') {
          ...
          // get the appid
          var appid = S(meta['twitter-app-id-iphone'] || '').trim().s.toLowerCase();

          // check if the playid was specified
          if( meta[ 'twitter-app-id-iphone' ] === null && 
            meta[ 'twitter-app-id-iphone' ] === undefined  ) {
            ...
            var build = payload.getSnippetManager().build(lines, -1, function(line) {
              ...
              return line.toLowerCase().indexOf('<meta') !== -1 && 
                        line.toLowerCase().indexOf('twitter:app:id:iphone') !== -1;
            ...
            payload.addRule({
              ...
              identifiers:  [ 'twitter:app:id:iphone', 'ITunes App Store' ],
              code:         build
            ...
            return request.head({
              ...
              url:      'https://itunes.apple.com/app/' + appid,
              timeout:  10 * 1000
              ...
              if((response || {}).statusCode === 404) {
                ...
                payload.addRule({
                  ...
                  identifiers:  [ appid, 'ITunes App Store' ],
                  code:         build
