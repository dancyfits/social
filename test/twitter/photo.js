...
const testFunc    = require('../../lib/rules/twitter/photo');
...
describe('Twitter', function() {
  ...
  describe('photo', function() {
    ...
    it('Should not return a error if no card tag is on page', function(done) {
      ...
      var content = fs.readFileSync('./samples/twitter/photo/missing.html');
    ...
    it('Should report a error if "photo" card type is used', function(done) {

      // read in the html sample
      var content = fs.readFileSync('./samples/twitter/photo/present.html');
    ...
    it('Should not return a error if the "summary" card type is used', function(done) {
      ...
      // read in the html sample
      var content = fs.readFileSync('./samples/twitter/photo/ok.html');
