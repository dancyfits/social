...
const testFunc    = require('../../lib/rules/twitter/googleplay');

describe('Twitter', function() {

  describe('googleplay', function() {

    it('Should not return a error if other type is specified', function(done) {

      // read in the html sample
      var content = fs.readFileSync('./samples/twitter/googleplay/summary.html');
    ...
    it('Should not return a error if not specified', function(done) {
      ...
      // read in the html sample
      var content = fs.readFileSync('./samples/twitter/googleplay/missing.html');
    ...
    it('Should return a error if the app id is blank', function(done) {
      ...
      // read in the html sample
      var content = fs.readFileSync('./samples/twitter/googleplay/blank.html');
    ...
    it('Should return a error if the app id specified does not exist', function(done) {
      ...
      // read in the html sample
      var content = fs.readFileSync('./samples/twitter/googleplay/invalid.html');
    ...
    it('Should not return a error if the appid specified was valid', function(done) {
      ...
      // read in the html sample
      var content = fs.readFileSync('./samples/twitter/googleplay/ok.html');
